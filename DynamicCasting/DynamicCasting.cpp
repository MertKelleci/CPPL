...
int main()
{
	...
	// Even though actuallyEnemy is an Enemy type, this still works. If the enemy and player classes share a common function, you can even call that from this pointer.
